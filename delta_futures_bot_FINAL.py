...
# PLACE LIMIT ENTRY
# ============================================================
# SIGNAL + EXCHANGE LIMIT ORDER PREVIEW
# ============================================================
def show_signal_order_preview(signal_data):
    """
    Display-only preview.
    IMPORTANT: This function NEVER sends an order.
    Existing trading logic/order payload remains unchanged.
    """
    ...
    signal_close = Decimal(str(signal_data["close"]))
    ...
    log("==================================================")
    log("CANDLE ID       :", signal_data.get("candle_id"))
    log("SIGNAL          :", signal_value)
    log("TREND           :", "BULLISH" if signal_data.get("trend") == 1 else "BEARISH")
    log("OPEN            :", price_str(signal_data.get("open")))
    log("HIGH            :", price_str(signal_data.get("high")))
    log("LOW             :", price_str(signal_data.get("low")))
    ...
    log("NEXT            :", "PRIVATE API CHECK -> ACTUAL ORDER REQUEST")
    log("==================================================")
...
def main():
    ...
    # Show signal and proposed exchange limit price before IP/private API checks.
