...
def get_confirmed_signal():
    ...
    # Do not process stale API data. The latest candle must be the
    # immediately previous completed 1-minute candle.
    ...
    if latest_closed_id != expected_closed_id:
        log(
            "WAITING FOR FRESH CLOSED CANDLE",
            "| EXPECTED:", expected_closed_id,
            "| RECEIVED:", latest_closed_id,
            "| DELAY_SECONDS:", expected_closed_id - latest_closed_id
        )
        return None
