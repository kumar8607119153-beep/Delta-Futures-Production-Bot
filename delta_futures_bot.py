...
def main():
    ...
    # Display the latest public-market signal and the exact proposed
    # LIMIT order before the runner IP/private API stage.
    initial_signal_data = get_confirmed_signal()
    show_signal_order_preview(initial_signal_data)
    ...
    record(
        ...
        symbol=SYMBOL,
        runner_ip=RUNNER_IP,
        message="1-minute production trading started"
    )
